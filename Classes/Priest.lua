...
SpellsByLevel = {
	...
	-- Shadow Word: Pain (Rank 4), Renew (Rank 4), Flash Heal (Rank 2)
	[26] = {992,6076,9472},
	-- Heal (Rank 3), Mind Blast (Rank 4), Psychic Scream (Rank 2), Holy Nova (Rank 2), Devouring Plague (Rank 2)
	...
	[32] = {552,6077,9473},
	-- Levitate, Shadow Word: Pain (Rank 5), Heal (Rank 4), Mind Blast (Rank 5), Resurrection (Rank 3)
	[34] = {1706,2767,6064,8105,10880},
	-- Dispel Magic (Rank 2), Power Word: Fortitude (Rank 4), Power Word: Shield (Rank 6), Holy Fire (Rank 4), Holy Nova (Rank 3), Devouring Plague (Rank 3)
	...
	-- Psychic Scream (Rank 3), Shadow Word: Pain (Rank 6), Power Word: Shield (Rank 7), Shadow Protection (Rank 2), Holy Fire (Rank 5)
	[42] = {10888,10892,10898,10957,15265},
	-- Mind Vision (Rank 2), Flash Heal (Rank 5), Renew (Rank 7), Devouring Plague (Rank 4), Holy Nova (Rank 4)
	...
	-- Shadow Word: Pain (Rank 7), Flash Heal (Rank 6), Renew (Rank 8), Inner Fire (Rank 5), Prayer of Healing (Rank 3), Divine Spirit (Rank 3)
	[50] = {10893,10916,10928,10951,10960,14819},
	-- Mind Blast (Rank 8), Greater Heal (Rank 3), Devouring Plague (Rank 5), Holy Nova (Rank 5)
	[52] = {10946,10964,19279,27800},
	-- Power Word: Shield (Rank 9), Smite (Rank 8), Holy Fire (Rank 7)
	[54] = {10900,10934,15267},
	-- Psychic Scream (Rank 4), Flash Heal (Rank 7), Renew (Rank 9), Shadow Protection (Rank 3), Prayer of Shadow Protection (Rank 1)
	[56] = {10890,10917,10929,10958,27683},
	-- Shadow Word: Pain (Rank 8), Mind Blast (Rank 9), Greater Heal (Rank 4), Resurrection (Rank 5)
	[58] = {10894,10947,10965,20770},
	-- Power Word: Shield (Rank 10), Power Word: Fortitude (Rank 6), Inner Fire (Rank 6), Shackle Undead (Rank 3), Prayer of Healing (Rank 4), Holy Fire (Rank 8), Devouring Plague (Rank 6), Prayer of Fortitude (Rank 2), Greater Heal (Rank 5), Renew (Rank 10), Prayer of Healing (Rank 5), Prayer of Spirit (Rank 1), Holy Nova (Rank 6), Divine Spirit (Rank 4)
	...
	-- Binding Heal (Rank 1)
	[64] = {32546},
	-- Power Word: Shield (Rank 11), Renew (Rank 11), Shadow Word: Pain (Rank 9)
	[65] = {25217,25221,25367},
	-- Holy Fire (Rank 9), Shadowfiend
	[66] = {25384,34433},
	-- Flash Heal (Rank 9)
	[67] = {25235},
	-- Greater Heal (Rank 7), Prayer of Healing (Rank 6), Holy Nova (Rank 7), Shadow Protection (Rank 4), Resurrection (Rank 6), Devouring Plague (Rank 7), Prayer of Mending (Rank 1)
	[68] = {25213,25308,25331,25433,25435,25467,33076},
	-- Smite (Rank 10), Mind Blast (Rank 11), Inner Fire (Rank 7)
	[69] = {25364,25375,25431},
	-- Power Word: Shield (Rank 12), Renew (Rank 12), Divine Spirit (Rank 5), Shadow Word: Pain (Rank 10), Power Word: Fortitude (Rank 7), Prayer of Fortitude (Rank 3), Mass Dispel, Shadow Word: Death (Rank 2), Prayer of Spirit (Rank 2), Prayer of Shadow Protection (Rank 2)
	[70] = {25218,25222,25312,25368,25389,25392,32375,32996,32999,39374},
	-- Inner Fire (Rank 8)
	[71] = {48040},
	-- Binding Heal (Rank 2), Holy Fire (Rank 10)
	[72] = {48119,48134},
	-- Greater Heal (Rank 8), Flash Heal (Rank 10), Devouring Plague (Rank 8)
	[73] = {48062,48070,48299},
	-- Prayer of Mending (Rank 2), Smite (Rank 11), Mind Blast (Rank 12)
	[74] = {48112,48122,48126},
	-- Mind Sear (Rank 1), Power Word: Shield (Rank 13), Renew (Rank 13), Holy Nova (Rank 8), Shadow Word: Pain (Rank 11), Shadow Word: Death (Rank 3)
	...
	-- Power Word: Shield (Rank 14), Renew (Rank 14), Divine Spirit (Rank 6), Prayer of Spirit (Rank 3), Holy Nova (Rank 9), Shadow Word: Pain (Rank 12), Shadow Word: Death (Rank 4), Power Word: Fortitude (Rank 8), Prayer of Fortitude (Rank 4), Mind Sear (Rank 2), Divine Hymn (Rank 1), Hymn of Hope, Hymn of Hope
	[80] = {48066,48068,48073,48074,48078,48125,48158,48161,48162,53023,64843,64901,64904}
}