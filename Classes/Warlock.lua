...
SpellsByLevel = {
	...
	-- Drain Mana, Sense Demons, Corruption (Rank 3), Drain Soul (Rank 2)
	...
	-- Curse of the Elements (Rank 1), Fear (Rank 2), Shadow Ward (Rank 1), Curse of Weakness (Rank 4)
	...
	[38] = {7651,8289,11711},
	-- Howl of Terror (Rank 1), Immolate (Rank 5), Demon Armor (Rank 3), Create Soulstone (Rank 3), Dreadsteed (Summon)
	...
	-- Soul Fire (Rank 1), Curse of Agony (Rank 5), Create Spellstone (Rank 2), Banish (Rank 2)
	[48] = {6353,11712,17727,18647},
	-- Inferno (Summon), Immolate (Rank 6), Curse of Tongues (Rank 2), Demon Armor (Rank 4), Searing Pain (Rank 5), Death Coil (Rank 2), Create Soulstone (Rank 4)
	[50] = {1122,11667,11719,11734,17922,17925,20756},
	...
	-- Fear (Rank 3), Life Tap (Rank 6), Soul Fire (Rank 2), Create Firestone (Rank 4)
	...
	-- Create Soulstone (Rank 6), Seed of Corruption (Rank 1), Demon Armor (Rank 6), Searing Pain (Rank 8), Soul Fire (Rank 4), Curse of Doom (Rank 2), Incinerate (Rank 2)
	...
	-- Immolate (Rank 10), Soul Fire (Rank 5), Seed of Corruption (Rank 2), Shadowflame (Rank 1)
	...
	-- Immolate (Rank 11), Soul Fire (Rank 6), Seed of Corruption (Rank 3), Incinerate (Rank 4), Curse of Doom (Rank 3), Demon Armor (Rank 8), Demonic Circle: Summon, Demonic Circle: Teleport, Life Tap (Rank 8), Ritual of Souls (Rank 2), Create Firestone (Rank 7), Shadowflame (Rank 2)
