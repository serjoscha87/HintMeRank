...
SpellsByLevel = {
	...
	[46] = {11578,11604},
	-- Heroic Strike (Rank 7), Thunder Clap (Rank 5), Execute (Rank 4), Shield Slam (Rank 2), Mortal Strike (Rank 2)
	[48] = {11566,11580,20661,23923,21551},
	-- Recklessness, Rend (Rank 6), Cleave (Rank 4)
	[50] = {1719,11573,11609},
	-- Battle Shout (Rank 6)
	[52] = {11551},
	-- Demoralizing Shout (Rank 5), Revenge (Rank 5), Slam (Rank 4), Shield Slam (Rank 3), Mortal Strike (Rank 3)
	[54] = {11556,11601,11605,23924,21552},
	-- Heroic Strike (Rank 8), Execute (Rank 5)
	[56] = {11567,20662},
	-- Thunder Clap (Rank 6)
	[58] = {11581},
	-- Rend (Rank 7), Cleave (Rank 5), Shield Slam (Rank 4), Heroic Strike (Rank 9), Revenge (Rank 6), Battle Shout (Rank 7), Mortal Strike (Rank 4), Devastate (Rank 2)
	[60] = {11574,20569,23925,25286,25288,25289,21553,30016},
	-- Slam (Rank 5)
	[61] = {25241},
	...
	-- Execute (Rank 6)
	[65] = {25234},
	-- Shield Slam (Rank 5), Heroic Strike (Rank 10), Mortal Strike (Rank 5)
	[66] = {25258,29707,25248},
	-- Thunder Clap (Rank 7)
	[67] = {25264},
	...
	[69] = {2048,25242},
	-- Intervene, Demoralizing Shout (Rank 7), Execute (Rank 7), Heroic Strike (Rank 11), Shield Slam (Rank 6), Revenge (Rank 8), Devastate (Rank 3), Mortal Strike (Rank 6)
	[70] = {3411,25203,25236,30324,30356,30357,30022,30330},
	...
	[74] = {47439,47474},
	-- Shield Slam (Rank 7), Enraged Regeneration, Mortal Strike (Rank 7), Devastate (Rank 4)
	[75] = {47487,55694,47485,47497},
	...
	[79] = {47437,47475},
	-- Commanding Shout (Rank 3), Execute (Rank 9), Shield Slam (Rank 8), Heroic Throw, Revenge (Rank 9), Mortal Strike (Rank 8), Devastate (Rank 5)
	[80] = {47440,47471,47488,57755,57823,47486,47498}
}